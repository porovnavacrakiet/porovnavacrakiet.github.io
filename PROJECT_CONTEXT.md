...
- Zdieľací titulok a opis sú v `index.html` v meta údajoch a rovnako v anglickom titulku otvorenej stránky. Používa sa angličtina: `TABLE TENNIS RACKET COMPARATOR — Compare Table Tennis Setups` a `Compare two table tennis setups based on your playing style.`; pridané sú aj Open Graph a Twitter meta údaje pre Messenger, WhatsApp a sociálne siete.
