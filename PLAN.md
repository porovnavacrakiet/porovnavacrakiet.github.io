...
Aktuálne sú verejne funkčné moduly **stolný tenis**, **padel** a **tenis**. Padelový a tenisový katalóg sa priebežne rozširujú o zdrojovo overené modely; interné porovnávacie metriky sú orientačné a web to musí jasne uvádzať. Úvodný výber športu používa samostatné fotonáhľady, ktoré sú na desktope zarovnané s pôvodnými kartami: pre tenis raketu na antuke a pre stolný tenis červenú raketu na modrom stole so sivou podlahou v pozadí; náhľady neobsahujú viditeľné nápisy značiek.

Desktopové náhľady tenisovej a stolnotenisovej karty musia kopírovať presné hranice fotografickej časti pôvodného podkladu až po čierny titulkový pás; nesmú pri nich vznikať medzery ani schody. Pravý okraj stolnotenisového náhľadu musí prekryť celý podklad titulkového pásu bez zásahu do jeho ľavej hrany. Na mobile majú mať obe nové karty vlastný čierny titulkový pás s jasne čitateľným názvom športu a stolnotenisová karta musí zostať zarovnaná v šírke mobilného zoznamu.
...
- Výsledok padelového porovnania pod stručným verdiktom vždy pridá dynamickú sekciu `DETAILED PADEL ANALYSIS:` s desiatimi praktickými kapitolami: tvar a základný charakter, prvé lopty po zmene, return a obranný lob, voleje, bandeja/vibora, smeč, prechod do útoku, spin a podmienky, komfort ruky a finálny verdikt. Text zohľadňuje dve vybrané paly aj profil hráča (stranu, prioritu a komfort ruky) a jasne uvádza, že interné metriky sú orientačné a nenahrádzajú test na kurte.
- **Tenis** je verejne dostupná podstránka `/tennis/`: porovnáva dve kompletné tenisové rakety cez značku → model a obsahuje voľný neoverený model (značka, model, rok výroby `1950`–`2026`). Katalóg má 85 reprezentatívnych modelov od 12 výrobcov: Artengo, Babolat, Diadem, Dunlop, HEAD, Prince, ProKennex, Solinco, Tecnifibre, Volkl, Wilson a Yonex. ARTENGO obsahuje osem aktuálne predávaných odlišných dospelých typov z oficiálneho Decathlon katalógu 2026: TR 190 Lite V2, TR 500, TR 500 Lite, TR 930 Spin 285, TR 930 Spin Pro, TR 990 Power Lite, TR 990 Power a TR 990 Power Pro; farebný Softfeel variant TR 500 nie je duplicitný model. BABOLAT obsahuje 18 aktuálnych odlišných dospelých typov 2026 z oficiálneho katalógu: Pure Aero Gen9 (98, štandard, Lite, +, S Lite, Team), Pure Drive Gen11 (107, 98, štandard, Lite, +, S Lite, Team) a Evo Gen2 (Aero, Aero Lite, Drive, Drive Lite, Strike). DUNLOP obsahuje šesť aktuálne predávaných dospelých typov FX 2026 z oficiálneho obchodu: FX 500 Tour, FX 500, FX 500 LS, FX 500 Lite, FX 500 Super Lite a FX Team 100; juniorské modely a staršie generácie CX/SX/LX nie sú vydávané za modelový rok 2026. Farebné edície a viac-kusové balenia sa nepočítajú ako samostatné modely. HEAD obsahuje 20 aktuálne predávaných odlišných dospelých typov 2026 z oficiálneho obchodu a radových stránok: Boom (Pro, MP, MP L, MP UL, Team), Extreme (Pro, MP, MP XL, MP L, MP UL, Team, Elite), Speed (Pro, Tour, MP, MP L, MP UL, Team, Elite) a Squared. PRINCE obsahuje štyri aktuálne predávané dospelé typy Tour 2026: Tour 98, Tour 100P, Tour 100 310 a Tour 100 290. Ide o novú sériu s konštrukciou ATS/Textreme/Zylon a ISO-Fiber; staršie Prince položky zostávajú ako historické porovnávacie modely. Juniorské rámy, farebné edície a staršie generácie sa nepočítajú ako nové 2026 typy. Pri každom modeli uvádza rok, hmotnosť bez výpletu, veľkosť hlavy a vzor výpletu; metriky power, control a spin sú orientačné hodnoty komparátora, nie hodnotenia výrobcu. Po prvom otvorení formulár predvolene porovnáva Babolat Pure Aero 98 Gen9 (ľavá strana; 305 g, 630 cm², 16×20) s HEAD Speed MP 2026 (pravá strana). Profil používa tenisové vstupy pre skúsenosť, frekvenciu, súťažný kontext, primárny povrch (tvrdý povrch, antuka alebo tráva), štýl hry, prioritu a komfort ruky. World Tennis (predtým ITF) nezverejňuje register schválených značiek alebo štandardných rakiet: turnajová raketa musí spĺňať Appendix II pravidiel tenisu. Stránka preto neuvádza individuálne „ITF approved“ tvrdenia; upozorňuje, že ide o konvenčné, neupravené rámové rakety a organizátor môže mať doplnkové podmienky. Je indexovateľná, má canonical URL, odkaz z domáceho výberu a záznam v sitemape. Výplet môže pribudnúť neskôr iba s vlastnými dátami a zrozumiteľnou metodikou.
...
- Aktualizácia katalógu tenis (26. 8. 2026): referenčný počet je **98 modelov**. PROKENNEX obsahuje 16 aktuálne predávaných dospelých konfigurácií z oficiálneho katalógu výrobcu: Black Ace 285, 300, 315, 105 a Pro (97); Ki 5, Ki 10, Ki 15 260 a Ki 15 300; Q+30, Q+20, Q+15, Q+5, Q+5 Pro, Q+Tour a Q+Tour Pro. Hmotnostné verzie Black Ace a Ki 15 sú samostatné položky, pretože výrobca uvádza odlišnú hmotnosť a vyváženie. Nejde o individuálne schválenia federáciou: World Tennis nemá verejný register štandardných rámov podľa značky/modelu a platí podmienka Appendix II Rules of Tennis.
- V desktopovom športovom launcheri zelený hover/focus rám leží vo vnútri presných hraníc každej foto-karty bez posunu alebo medzery. Klikacia vrstva pokrýva plnú výšku panelu vrátane čierneho titulkového pásu; Tennis a Table Tennis používajú pre náhľad aj klikaciu vrstvu zhodné súradnice, ich zelený rám má plné spodné rohy bez svetlých medzier a hover kartu neposúva.
- Diadem v tenisovom katalógu obsahuje sedem odlišných dospelých typov uvedených výrobcom v roku 2026: Elevate V4 98, Tour 98 a Team 98, Elina Svitolina Signature Axis 98 a limitovanú aktuálnu iteráciu Project Bublik 98, 100 a Team 100. Farebné, demo a staršie V3 varianty sa nevedú ako modely 2026. Project Bublik sa v oficiálnom zdroji označuje ako priebežne vyvíjaný projekt, preto sa pri ňom nesmie tvrdiť konečná profesionálna špecifikácia.
- Tenisový porovnávač pod výberom výrobcu a modelu každej rakety obsahuje vstupný blok výpletu: formát (celý výplet alebo hybrid), značka a model, materiálová rodina (monofilament polyester, multifilament, prírodné črievko alebo synthetic gut), priemer/gauge, tvar, samostatné napätie pozdĺžnych a priečnych strún a vek výpletu. Pri otvorení stránky je formát predvolený na bežný celý výplet; značka/model, rodina, priemer, tvar, obe napätia aj vek výpletu sú prázdne a výberové polia zobrazujú `— Select —`. Po každom kliknutí na porovnanie výsledok vždy pridá `DETAILED TENNIS ANALYSIS` s desiatimi kapitolami: porovnanie rámov, sila a hĺbka, kontrola, spin a vzor, aktuálny a cieľový výplet, napätie a priemer, komfort, herný kontext a praktický testovací verdikt. Text pracuje so zadanými údajmi výpletu, jasne označí chýbajúce údaje a netvrdí umelé presné skóre pre konkrétnu strunu bez vlastného overeného katalógu.
- Domovská stránka je spoločným vstupom značky: pri prvom otvorení zobrazuje iba vizuálny výber **Padel / Tennis / Table Tennis** cez `assets/sport-racket-comparator-launcher-v5.png`. Všetky tri karty vedú na funkčný modul. Padelová karta používa fotku na modrom kurte s čistou neoznačenou palou a žltou loptičkou bez loga; tenisová karta používa čistú čiernu raketu a žltú loptičku bez loga na zelenej tráve; stolnotenisová karta má čistý čierny stôl bez sieťky a červeného okraja. Na mobile má každá z troch kariet rovnakú plnú šírku a pomer strán.
...
Spracovanie: návrhy sa ukladajú iba do `localStorage` prehliadača (kľúč `racket-comparator-feedback`) najviac na 30 dní. E-mail sa nezbiera ani neukladá; používateľ môže uložené návrhy okamžite vymazať. Server ani e-mail nie sú pripojené.
...
- Hlavný SEO titulok domovskej stránky je `SPORT RACKET COMPARATOR | Find Your Racket`; univerzálny anglický opis je `Compare padel rackets, tennis racquets and table tennis blades, bats and complete setups.`. Opis je zhodný v meta opise, Open Graph, Twitter a Schema.org údajoch. Domovská stránka má aj viditeľný odkaz na porovnávanie padelových rakiet, tenisových rakiet/racquetov a stolnotenisových zostáv.
- Športové moduly majú samostatné, presné SEO titulky a opisy: tenisový modul používa aj pravopisný variant `tennis racquets` a viditeľne vysvetľuje hľadanie rakiet s podobným herným pocitom; padelový modul viditeľne uvádza `padel racket comparison tool`. Tieto formulácie musia zostať užitočným opisom funkcie, nie izolovaným alebo skrytým zoznamom kľúčových slov.
- Padelový modul používa pre používateľsky viditeľnú terminológiu výlučne `racket`, nie `pala`. Jeho HTML titulok je `SPORT RACKET COMPARATOR`, pričom Open Graph a Twitter dopĺňajú presný kontext `Padel Racket Comparison`.
- Pre všeobecný zámer porovnávania používa domovská stránka viditeľné pomenovanie `racket comparison tools`; tenisový a padelový modul používajú prirodzené varianty `racket comparison tool` a `compare ... racquets/rackets`; stolnotenisový modul používa `table tennis blade and bat comparison tool`. Výraz `bat` sa nesmie používať pre tenis ani padel. Web sa neoznačuje za „best comparison tool“ alebo „best website“, pretože také hodnotenie nie je overiteľný fakt.
