...
function toggleLeague(){const isRegistered=$('player-status').value==='registered',leagueWrap=$('league-wrap'),equivalentWrap=$('equivalent-wrap'),leagueSelect=$('league-level'),equivalentSelect=$('equivalent-level');leagueWrap.classList.toggle('hidden',!isRegistered);equivalentWrap.classList.toggle('hidden',isRegistered);leagueWrap.style.display=isRegistered?'block':'none';equivalentWrap.style.display=isRegistered?'none':'block';leagueSelect.disabled=!isRegistered;equivalentSelect.disabled=isRegistered;}
