...
const rubbers = [
  ...
  {id:'yasaka-anti-power',brand:'Yasaka',name:'Anti Power · 1.5 mm',speed:42,control:90,spin:38,hardness:32},
  {id:'yasaka-elfark-rf',brand:'Yasaka',name:'Elfark RF · 2.0 mm',speed:67,control:82,spin:76,hardness:38},
  {id:'yasaka-elfark-rf-ox',brand:'Yasaka',name:'Elfark RF · OX',speed:48,control:88,spin:68,hardness:25},
  {id:'yasaka-mark-v',brand:'Yasaka',name:'Mark V · 2.0 mm',speed:72,control:82,spin:84,hardness:45},
  {id:'yasaka-mark-v-30',brand:'Yasaka',name:'Mark V 30° · 2.0 mm',speed:65,control:88,spin:82,hardness:30},
  {id:'yasaka-mark-v-ad',brand:'Yasaka',name:'Mark V AD · 2.0 mm',speed:70,control:84,spin:82,hardness:40},
  {id:'yasaka-mark-v-hps',brand:'Yasaka',name:'Mark V HPS · 2.0 mm',speed:80,control:76,spin:88,hardness:47},
  {id:'yasaka-mark-v-hps-soft',brand:'Yasaka',name:'Mark V HPS Soft · 2.0 mm',speed:76,control:80,spin:87,hardness:40},
  {id:'yasaka-mark-v-m2',brand:'Yasaka',name:'Mark V M2 · 2.0 mm',speed:70,control:85,spin:83,hardness:42},
  {id:'yasaka-mark-v-xs',brand:'Yasaka',name:'Mark V XS · 2.0 mm',speed:76,control:80,spin:86,hardness:45},
  {id:'yasaka-original-soft',brand:'Yasaka',name:'Original Soft · 2.0 mm',speed:63,control:87,spin:77,hardness:35},
  {id:'yasaka-original-extra',brand:'Yasaka',name:'Original Extra · 2.0 mm',speed:68,control:84,spin:80,hardness:42},
  {id:'yasaka-original-pips-out',brand:'Yasaka',name:'Original (Pips-Out) · 1.5 mm',speed:64,control:84,spin:69,hardness:38},
  {id:'yasaka-original-t-version',brand:'Yasaka',name:'Original T Version · 1.5 mm',speed:67,control:82,spin:73,hardness:40},
  {id:'yasaka-phantom-0011',brand:'Yasaka',name:'Phantom 0011∞ · OX',speed:34,control:91,spin:67,hardness:22},
  {id:'yasaka-phantom-0012',brand:'Yasaka',name:'Phantom 0012∞ · OX',speed:31,control:92,spin:69,hardness:20},
  {id:'yasaka-phantom-007',brand:'Yasaka',name:'Phantom 007 · OX',speed:38,control:90,spin:64,hardness:24},
  {id:'yasaka-phantom-008',brand:'Yasaka',name:'Phantom 008 · OX',speed:36,control:91,spin:66,hardness:22},
  {id:'yasaka-phantom-009',brand:'Yasaka',name:'Phantom 009 · OX',speed:40,control:89,spin:65,hardness:25},
  {id:'yasaka-rakza-7',brand:'Yasaka',name:'Rakza 7 · 2.0 mm',speed:75,control:78,spin:86,hardness:45},
  {id:'yasaka-rakza-7-hard',brand:'Yasaka',name:'Rakza 7 Hard · 2.0 mm',speed:82,control:73,spin:90,hardness:52},
  {id:'yasaka-rakza-7-soft',brand:'Yasaka',name:'Rakza 7 Soft · 2.0 mm',speed:70,control:83,spin:86,hardness:37},
  {id:'yasaka-rakza-9',brand:'Yasaka',name:'Rakza 9 · 2.0 mm',speed:82,control:74,spin:88,hardness:45},
  {id:'yasaka-rakza-po',brand:'Yasaka',name:'Rakza PO · 2.0 mm',speed:81,control:76,spin:82,hardness:45},
  {id:'yasaka-rakza-x',brand:'Yasaka',name:'Rakza X · 2.0 mm',speed:83,control:75,spin:91,hardness:47},
  {id:'yasaka-rakza-x-soft',brand:'Yasaka',name:'Rakza X Soft · 2.0 mm',speed:78,control:80,spin:90,hardness:40},
  {id:'yasaka-rakza-xx',brand:'Yasaka',name:'Rakza XX · 2.0 mm',speed:88,control:70,spin:94,hardness:52},
  {id:'yasaka-rakza-z',brand:'Yasaka',name:'Rakza Z · 2.0 mm',speed:78,control:79,spin:94,hardness:47},
  {id:'yasaka-rakza-z-extra-hard',brand:'Yasaka',name:'Rakza Z Extra Hard · 2.0 mm',speed:85,control:72,spin:96,hardness:52},
  {id:'yasaka-rigan',brand:'Yasaka',name:'Rigan · 2.0 mm',speed:72,control:81,spin:84,hardness:40},
  {id:'yasaka-rigan-spin',brand:'Yasaka',name:'Rigan Spin · 2.0 mm',speed:74,control:79,spin:87,hardness:42},
  {id:'yasaka-rising-dragon-ii',brand:'Yasaka',name:'Rising Dragon II · 2.0 mm',speed:80,control:76,spin:91,hardness:47},
  {id:'yasaka-shining-dragon-ii',brand:'Yasaka',name:'Shining Dragon II · 2.0 mm',speed:82,control:74,spin:92,hardness:50},
  {id:'yasaka-spinate',brand:'Yasaka',name:'Spinate · 1.8 mm',speed:65,control:84,spin:79,hardness:38},
  {id:'yasaka-trick-anti',brand:'Yasaka',name:'Trick Anti · 1.5 mm',speed:40,control:91,spin:35,hardness:30},
  {id:'yasaka-wallie',brand:'Yasaka',name:'Wallie · 1.5 mm',speed:58,control:86,spin:74,hardness:35},
  {id:'yasaka-xtend',brand:'Yasaka',name:'Xtend · 2.0 mm',speed:76,control:78,spin:86,hardness:42},
  {id:'yasaka-xtend-hs',brand:'Yasaka',name:'Xtend HS · 2.0 mm',speed:82,control:73,spin:90,hardness:47},
  {id:'xiom-jh-c-52-5',brand:'Xiom',name:'JEKYLL & HYDE C 52.5 · 2.0 mm',speed:88,control:71,spin:96,hardness:52.5},
  {id:'xiom-jh-c-55',brand:'Xiom',name:'JEKYLL & HYDE C 55.0 · 2.0 mm',speed:91,control:67,spin:97,hardness:55},
  {id:'xiom-jh-c-57-5',brand:'Xiom',name:'JEKYLL & HYDE C 57.5 · 2.0 mm',speed:93,control:64,spin:98,hardness:57.5},
  {id:'xiom-jh-h-52-5',brand:'Xiom',name:'JEKYLL & HYDE H 52.5 · 2.0 mm',speed:88,control:70,spin:95,hardness:52.5},
  {id:'xiom-jh-v-47-5',brand:'Xiom',name:'JEKYLL & HYDE V 47.5 · 2.0 mm',speed:81,control:78,spin:92,hardness:47.5},
  {id:'xiom-jh-v-52-5',brand:'Xiom',name:'JEKYLL & HYDE V 52.5 · 2.0 mm',speed:86,control:73,spin:94,hardness:52.5},
  {id:'xiom-jh-x-47-5',brand:'Xiom',name:'JEKYLL & HYDE X 47.5 · 2.0 mm',speed:84,control:76,spin:93,hardness:47.5},
  {id:'xiom-jh-x-50',brand:'Xiom',name:'JEKYLL & HYDE X 50.0 · 2.0 mm',speed:88,control:71,spin:94,hardness:50},
  {id:'xiom-jh-z-52-5',brand:'Xiom',name:'JEKYLL & HYDE Z 52.5 · 2.0 mm',speed:90,control:69,spin:95,hardness:52.5},
  {id:'xiom-musa-1',brand:'Xiom',name:'MUSA 1 · 2.0 mm',speed:64,control:86,spin:78,hardness:45},
  {id:'xiom-musa-3',brand:'Xiom',name:'MUSA 3 · 2.0 mm',speed:72,control:81,spin:83,hardness:47.5},
  {id:'xiom-omega-2-asia',brand:'Xiom',name:'OMEGA 2 Asia · 2.0 mm',speed:79,control:75,spin:87,hardness:47.5},
  {id:'xiom-omega-2-pro',brand:'Xiom',name:'OMEGA 2 Pro · 2.0 mm',speed:81,control:73,spin:88,hardness:47.5},
  {id:'xiom-omega-3-euro',brand:'Xiom',name:'OMEGA 3 Euro · 2.0 mm',speed:76,control:79,spin:87,hardness:45},
  {id:'xiom-omega-3-pro',brand:'Xiom',name:'OMEGA 3 Pro · 2.0 mm',speed:82,control:72,spin:90,hardness:47.5},
  {id:'xiom-omega-4-asia',brand:'Xiom',name:'OMEGA 4 Asia · 2.0 mm',speed:85,control:70,spin:91,hardness:50},
  {id:'xiom-omega-4-euro',brand:'Xiom',name:'OMEGA 4 Euro · 2.0 mm',speed:79,control:77,spin:89,hardness:45},
  {id:'xiom-omega-4-pro',brand:'Xiom',name:'OMEGA 4 Pro · 2.0 mm',speed:84,control:71,spin:91,hardness:47.5},
  {id:'xiom-omega-5-asia-dyn-f',brand:'Xiom',name:'OMEGA 5 Asia Dyn F · 2.0 mm',speed:87,control:69,spin:92,hardness:50},
  {id:'xiom-omega-5-euro-dyn-f',brand:'Xiom',name:'OMEGA 5 Euro Dyn F · 2.0 mm',speed:81,control:76,spin:90,hardness:45},
  {id:'xiom-omega-5-pro',brand:'Xiom',name:'OMEGA 5 Pro · 2.0 mm',speed:86,control:70,spin:92,hardness:47.5},
  {id:'xiom-omega-5-tour-dyn-f',brand:'Xiom',name:'OMEGA 5 Tour Dyn F · 2.0 mm',speed:90,control:66,spin:93,hardness:50},
  {id:'xiom-omega-7-asia',brand:'Xiom',name:'OMEGA 7 Asia · 2.0 mm',speed:88,control:69,spin:93,hardness:52.5},
  {id:'xiom-omega-7-china-guang',brand:'Xiom',name:'OMEGA 7 China Guang · 2.0 mm',speed:86,control:72,spin:96,hardness:55},
  {id:'xiom-omega-7-china-ying',brand:'Xiom',name:'OMEGA 7 China Ying · 2.0 mm',speed:82,control:77,spin:95,hardness:52.5},
  {id:'xiom-omega-7-euro',brand:'Xiom',name:'OMEGA 7 Euro · 2.0 mm',speed:82,control:77,spin:91,hardness:45},
  {id:'xiom-omega-7-hyper',brand:'Xiom',name:'OMEGA 7 Hyper · 2.0 mm',speed:91,control:65,spin:94,hardness:55},
  {id:'xiom-omega-7-pro',brand:'Xiom',name:'OMEGA 7 Pro · 2.0 mm',speed:87,control:69,spin:93,hardness:47.5},
  {id:'xiom-omega-7-tour',brand:'Xiom',name:'OMEGA 7 Tour · 2.0 mm',speed:90,control:66,spin:94,hardness:55},
  {id:'xiom-omega-8-china',brand:'Xiom',name:'OMEGA 8 China · 2.0 mm',speed:88,control:71,spin:97,hardness:55},
  {id:'xiom-omega-8-euro',brand:'Xiom',name:'OMEGA 8 Euro · 2.0 mm',speed:84,control:76,spin:93,hardness:47.5},
  {id:'xiom-omega-8-hybrid',brand:'Xiom',name:'OMEGA 8 Hybrid · 2.0 mm',speed:87,control:73,spin:96,hardness:52.5},
  {id:'xiom-omega-8-pro',brand:'Xiom',name:'OMEGA 8 Pro · 2.0 mm',speed:91,control:67,spin:95,hardness:52.5},
  {id:'xiom-sigma-2-euro',brand:'Xiom',name:'SIGMA 2 Euro · 2.0 mm',speed:76,control:78,spin:87,hardness:45},
  {id:'xiom-sigma-2-pro',brand:'Xiom',name:'SIGMA 2 Pro · 2.0 mm',speed:82,control:72,spin:90,hardness:47.5},
  {id:'xiom-sigma-3',brand:'Xiom',name:'SIGMA 3 · 2.0 mm',speed:83,control:71,spin:91,hardness:47.5},
  {id:'xiom-sigma-4',brand:'Xiom',name:'SIGMA 4 · 2.0 mm',speed:86,control:69,spin:92,hardness:50},
  {id:'xiom-sigma-5',brand:'Xiom',name:'SIGMA 5 · 2.0 mm',speed:88,control:67,spin:93,hardness:52.5},
  {id:'xiom-tau-2',brand:'Xiom',name:'TAU2 · 2.0 mm',speed:78,control:77,spin:96,hardness:52.5},
  {id:'xiom-tau-3',brand:'Xiom',name:'TAU3 · 2.0 mm',speed:85,control:73,spin:98,hardness:55},
  {id:'xiom-vega-asia',brand:'Xiom',name:'VEGA Asia · 2.0 mm',speed:79,control:75,spin:88,hardness:47.5},
  {id:'xiom-vega-asia-dyn-f',brand:'Xiom',name:'VEGA Asia Dyn F · 2.0 mm',speed:82,control:73,spin:90,hardness:47.5},
  {id:'xiom-vega-asia-h',brand:'Xiom',name:'VEGA Asia H · 2.0 mm',speed:83,control:73,spin:92,hardness:50},
  {id:'xiom-vega-china',brand:'Xiom',name:'VEGA China · 2.0 mm',speed:74,control:81,spin:94,hardness:52.5},
  {id:'xiom-vega-china-plus',brand:'Xiom',name:'VEGA China+ · 2.0 mm',speed:80,control:76,spin:96,hardness:55},
  {id:'xiom-vega-elite',brand:'Xiom',name:'VEGA Elite · 2.0 mm',speed:69,control:86,spin:83,hardness:42.5},
  {id:'xiom-vega-europe',brand:'Xiom',name:'VEGA Europe · 2.0 mm',speed:74,control:82,spin:86,hardness:42.5},
  {id:'xiom-vega-europe-dyn-f',brand:'Xiom',name:'VEGA Europe Dyn F · 2.0 mm',speed:77,control:80,spin:89,hardness:45},
  {id:'xiom-vega-europe-h',brand:'Xiom',name:'VEGA Europe H · 2.0 mm',speed:75,control:83,spin:90,hardness:45},
  {id:'xiom-vega-intro',brand:'Xiom',name:'VEGA Intro · 2.0 mm',speed:65,control:88,spin:79,hardness:42.5},
  {id:'xiom-vega-japan',brand:'Xiom',name:'VEGA Japan · 2.0 mm',speed:77,control:79,spin:88,hardness:45},
  {id:'xiom-vega-korea',brand:'Xiom',name:'VEGA Korea · 2.0 mm',speed:82,control:73,spin:90,hardness:47.5},
  {id:'xiom-vega-pro',brand:'Xiom',name:'VEGA Pro · 2.0 mm',speed:76,control:76,spin:88,hardness:47},
  {id:'xiom-vega-pro-h',brand:'Xiom',name:'VEGA PRO H · 2.0 mm',speed:84,control:71,spin:93,hardness:50},
  {id:'xiom-vega-spo',brand:'Xiom',name:'VEGA SPO · 2.0 mm',speed:73,control:81,spin:61,hardness:40},
  {id:'xiom-vega-tour',brand:'Xiom',name:'VEGA Tour · 2.0 mm',speed:84,control:71,spin:91,hardness:47.5},
  {id:'xiom-vega-x',brand:'Xiom',name:'VEGA X · 2.0 mm',speed:81,control:76,spin:90,hardness:47.5},
  {id:'xiom-zeta-asia',brand:'Xiom',name:'ZETA Asia · 2.0 mm',speed:80,control:75,spin:89,hardness:47.5},
  {id:'xiom-zeta-china',brand:'Xiom',name:'ZETA China · 2.0 mm',speed:82,control:73,spin:93,hardness:50},
  {id:'victas-curl-p1v',brand:'Victas',name:'CURL P1V · OX',speed:34,control:94,spin:38,hardness:20},
  {id:'victas-curl-p2v',brand:'Victas',name:'CURL P2V · 1.5 mm',speed:61,control:86,spin:52,hardness:32.5},
  {id:'victas-curl-p3v',brand:'Victas',name:'CURL P3V · OX',speed:38,control:91,spin:35,hardness:20},
  {id:'victas-curl-p3av',brand:'Victas',name:'CURL P3aV · OX',speed:36,control:93,spin:34,hardness:20},
  {id:'victas-curl-p4v',brand:'Victas',name:'CURL P4V · OX',speed:31,control:96,spin:31,hardness:20},
  {id:'victas-curl-p5v',brand:'Victas',name:'CURL P5V · OX',speed:42,control:89,spin:42,hardness:20},
  {id:'victas-spectol-s1',brand:'Victas',name:'SPECTOL S1 · 2.0 mm',speed:81,control:76,spin:64,hardness:35},
  {id:'victas-spectol-s2',brand:'Victas',name:'SPECTOL S2 · 2.0 mm',speed:79,control:78,spin:68,hardness:37.5},
  {id:'victas-spectol-s3',brand:'Victas',name:'SPECTOL S3 · 2.0 mm',speed:76,control:81,spin:62,hardness:35},
  {id:'victas-spinpips-d1',brand:'Victas',name:'SPINPIPS D1 · 2.0 mm',speed:74,control:82,spin:72,hardness:40},
  {id:'victas-spinpips-d2',brand:'Victas',name:'SPINPIPS D2 · 2.0 mm',speed:78,control:78,spin:67,hardness:40},
  {id:'victas-spinpips-d3',brand:'Victas',name:'SPINPIPS D3 · 2.0 mm',speed:71,control:84,spin:64,hardness:35},
  {id:'victas-swat-pw-spin',brand:'Victas',name:'Swat PW Spin · 2.0 mm',speed:76,control:80,spin:88,hardness:42.5},
  {id:'victas-swat-spin',brand:'Victas',name:'Swat Spin · 2.0 mm',speed:72,control:84,spin:85,hardness:40},
  {id:'victas-triple-double-extra',brand:'Victas',name:'TRIPLE Double Extra · 2.0 mm',speed:89,control:70,spin:97,hardness:55},
  {id:'victas-triple-extra',brand:'Victas',name:'TRIPLE Extra · 2.0 mm',speed:82,control:76,spin:95,hardness:52.5},
  {id:'victas-triple-regular',brand:'Victas',name:'TRIPLE Regular · 2.0 mm',speed:74,control:82,spin:93,hardness:47.5},
  {id:'victas-v-01',brand:'Victas',name:'V > 01 · 2.0 mm',speed:79,control:78,spin:88,hardness:47.5},
  {id:'victas-v-01-limber',brand:'Victas',name:'V > 01 Limber · 2.0 mm',speed:72,control:84,spin:86,hardness:40},
  {id:'victas-v-01-stiff',brand:'Victas',name:'V > 01 Stiff · 2.0 mm',speed:84,control:73,spin:88,hardness:50},
  {id:'victas-v-11-extra',brand:'Victas',name:'V > 11 Extra · 2.0 mm',speed:80,control:76,spin:89,hardness:47.5},
  {id:'victas-v-15-extra',brand:'Victas',name:'V > 15 Extra · 2.0 mm',speed:83,control:69,spin:90,hardness:47},
  {id:'victas-v-15-limber',brand:'Victas',name:'V > 15 Limber · 2.0 mm',speed:76,control:78,spin:89,hardness:40},
  {id:'victas-v-15-stiff',brand:'Victas',name:'V > 15 Stiff · 2.0 mm',speed:86,control:67,spin:90,hardness:50},
  {id:'victas-v-15-sticky',brand:'Victas',name:'V > 15 Sticky · 2.0 mm',speed:80,control:75,spin:95,hardness:52.5},
  {id:'victas-v-15-sticky-soft',brand:'Victas',name:'V > 15 Sticky Soft · 2.0 mm',speed:75,control:82,spin:94,hardness:47.5},
  {id:'victas-v-20-double-extra',brand:'Victas',name:'V > 20 Double Extra · 2.0 mm',speed:91,control:64,spin:93,hardness:52.5},
  {id:'victas-v-20-extra',brand:'Victas',name:'V > 20 Extra · 2.0 mm',speed:87,control:69,spin:92,hardness:47.5},
  {id:'victas-v-22-double-extra',brand:'Victas',name:'V > 22 Double Extra · 2.0 mm',speed:94,control:61,spin:94,hardness:52.5},
  {id:'victas-ventus-extra',brand:'Victas',name:'VENTUS Extra · 2.0 mm',speed:84,control:72,spin:90,hardness:47.5},
  {id:'victas-ventus-limber',brand:'Victas',name:'VENTUS Limber · 2.0 mm',speed:75,control:83,spin:87,hardness:40},
  {id:'victas-ventus-regular',brand:'Victas',name:'VENTUS Regular · 2.0 mm',speed:67,control:87,spin:80,hardness:40},
  {id:'victas-ventus-regular-alpha',brand:'Victas',name:'VENTUS Regular α · 2.0 mm',speed:69,control:86,spin:82,hardness:42.5},
  {id:'victas-ventus-stiff',brand:'Victas',name:'VENTUS Stiff · 2.0 mm',speed:80,control:77,spin:89,hardness:45},
  {id:'victas-vj-07-regular',brand:'Victas',name:'VJ > 07 Regular · 2.0 mm',speed:74,control:82,spin:86,hardness:42.5},
  {id:'victas-vj-07-stiff',brand:'Victas',name:'VJ > 07 Stiff · 2.0 mm',speed:79,control:77,spin:88,hardness:47.5},
  {id:'victas-vo-101',brand:'Victas',name:'VO > 101 · 2.0 mm',speed:77,control:79,spin:62,hardness:40},
  {id:'victas-vo-102',brand:'Victas',name:'VO > 102 · 2.0 mm',speed:75,control:81,spin:58,hardness:37.5},
  {id:'victas-vo-103',brand:'Victas',name:'VO > 103 · 2.0 mm',speed:72,control:84,spin:55,hardness:35},
  {id:'victas-vs-401',brand:'Victas',name:'VS > 401 · 2.0 mm',speed:68,control:85,spin:94,hardness:57.5},
  {id:'victas-vs-402-double-extra',brand:'Victas',name:'VS > 402 Double Extra · 2.0 mm',speed:82,control:75,spin:96,hardness:55},
  {id:'victas-vs-402-limber',brand:'Victas',name:'VS > 402 Limber · 2.0 mm',speed:72,control:83,spin:94,hardness:47.5},
  {id:'victas-xegna',brand:'Victas',name:'XEGNA · 2.0 mm',speed:88,control:70,spin:93,hardness:47.5},
  {id:'victas-xegna-spin',brand:'Victas',name:'XEGNA SPIN · 2.0 mm',speed:83,control:75,spin:96,hardness:47.5},
  {id:'tibhar-aurus',brand:'Tibhar',name:'Aurus · 2.1 mm',speed:72,control:80,spin:82,hardness:47.5},
  {id:'tibhar-aurus-prime',brand:'Tibhar',name:'Aurus Prime · 2.1 mm',speed:80,control:72,spin:87,hardness:47.5},
  {id:'tibhar-aurus-select',brand:'Tibhar',name:'Aurus Select · 2.1 mm',speed:71,control:80,spin:85,hardness:45},
  {id:'tibhar-aurus-soft',brand:'Tibhar',name:'Aurus Soft · 2.1 mm',speed:67,control:84,spin:83,hardness:42.5},
  {id:'tibhar-aurus-sound',brand:'Tibhar',name:'Aurus Sound · 2.1 mm',speed:64,control:88,spin:84,hardness:35},
  {id:'tibhar-ellen-def-off',brand:'Tibhar',name:'Ellen DEF/OFF · 1.5 mm',speed:38,control:88,spin:48,hardness:33},
  {id:'tibhar-evolution-el-d',brand:'Tibhar',name:'Evolution EL-D · 2.1 mm',speed:85,control:70,spin:92,hardness:46},
  {id:'tibhar-evolution-el-p',brand:'Tibhar',name:'Evolution EL-P · 2.1 mm',speed:80,control:76,spin:90,hardness:43},
  {id:'tibhar-evolution-el-s',brand:'Tibhar',name:'Evolution EL-S · 2.1 mm',speed:82,control:76,spin:92,hardness:45},
  {id:'tibhar-evolution-fx-d',brand:'Tibhar',name:'Evolution FX-D · 2.1 mm',speed:79,control:75,spin:92,hardness:44},
  {id:'tibhar-evolution-fx-p',brand:'Tibhar',name:'Evolution FX-P · 2.1 mm',speed:76,control:80,spin:90,hardness:40},
  {id:'tibhar-evolution-fx-s',brand:'Tibhar',name:'Evolution FX-S · 2.1 mm',speed:78,control:78,spin:92,hardness:42},
  {id:'tibhar-evolution-mx-d',brand:'Tibhar',name:'Evolution MX-D · 2.1 mm',speed:89,control:67,spin:93,hardness:51},
  {id:'tibhar-evolution-mx-p',brand:'Tibhar',name:'Evolution MX-P · 2.1 mm',speed:84,control:68,spin:91,hardness:47},
  {id:'tibhar-evolution-mx-p50',brand:'Tibhar',name:'Evolution MX-P 50 · 2.1 mm',speed:87,control:67,spin:92,hardness:50},
  {id:'tibhar-evolution-mx-s',brand:'Tibhar',name:'Evolution MX-S · 2.1 mm',speed:84,control:68,spin:91,hardness:47},
  {id:'tibhar-game',brand:'Tibhar',name:'Game · 2.0 mm',speed:63,control:74,spin:75,hardness:32.5},
  {id:'tibhar-genius',brand:'Tibhar',name:'Genius · 2.0 mm',speed:70,control:80,spin:81,hardness:47.5},
  {id:'tibhar-grass',brand:'Tibhar',name:'Grass · OX',speed:36,control:84,spin:60,hardness:20},
  {id:'tibhar-grass-d-tecs',brand:'Tibhar',name:'Grass D.Tecs · OX',speed:40,control:82,spin:64,hardness:20},
  {id:'tibhar-hybrid-k1-european',brand:'Tibhar',name:'Hybrid K1 European Version · 2.0 mm',speed:70,control:76,spin:87,hardness:50},
  {id:'tibhar-hybrid-k3',brand:'Tibhar',name:'Hybrid K3 · 2.0 mm',speed:82,control:82,spin:96,hardness:53},
  {id:'tibhar-hybrid-k3-fx',brand:'Tibhar',name:'Hybrid K3 FX · 2.0 mm',speed:78,control:86,spin:96,hardness:48},
  {id:'tibhar-hybrid-k3-pro',brand:'Tibhar',name:'Hybrid K3 Pro · 2.0 mm',speed:84,control:76,spin:96,hardness:55},
  {id:'tibhar-hybrid-mk',brand:'Tibhar',name:'Hybrid MK · 2.0 mm',speed:84,control:88,spin:93,hardness:48},
  {id:'tibhar-hybrid-mk-fx',brand:'Tibhar',name:'Hybrid MK FX · 2.0 mm',speed:70,control:92,spin:93,hardness:45},
  {id:'tibhar-learn-spin',brand:'Tibhar',name:'Learn Spin · 1.5 mm',speed:42,control:88,spin:60,hardness:30},
  {id:'tibhar-legend',brand:'Tibhar',name:'Legend · 2.0 mm',speed:57,control:80,spin:74,hardness:42.5},
  {id:'tibhar-nimbus',brand:'Tibhar',name:'Nimbus · 2.0 mm',speed:69,control:80,spin:75,hardness:45},
  {id:'tibhar-nimbus-soft',brand:'Tibhar',name:'Nimbus Soft · 2.0 mm',speed:65,control:84,spin:75,hardness:37.5},
  {id:'tibhar-nimbus-sound',brand:'Tibhar',name:'Nimbus Sound · 2.0 mm',speed:62,control:88,spin:76,hardness:32.5},
  {id:'tibhar-norm',brand:'Tibhar',name:'Norm · 1.7 mm',speed:44,control:80,spin:62,hardness:35},
  {id:'tibhar-quantum-x-pro',brand:'Tibhar',name:'Quantum X Pro · 2.1 mm',speed:76,control:72,spin:85,hardness:47.5},
  {id:'tibhar-rapid',brand:'Tibhar',name:'Rapid · 2.0 mm',speed:62,control:80,spin:72,hardness:42.5},
  {id:'tibhar-rapid-soft',brand:'Tibhar',name:'Rapid Soft · 2.0 mm',speed:61,control:84,spin:73,hardness:35},
  {id:'tibhar-speedy-soft',brand:'Tibhar',name:'Speedy Soft · 1.5 mm',speed:65,control:80,spin:58,hardness:45},
  {id:'tibhar-speedy-soft-d-tecs',brand:'Tibhar',name:'Speedy Soft D.Tecs · 1.5 mm',speed:67,control:79,spin:52,hardness:35},
  {id:'tibhar-speedy-soft-d-tecs-xd',brand:'Tibhar',name:'Speedy Soft D.Tecs XD · 1.5 mm',speed:76,control:68,spin:55,hardness:40},
  {id:'tibhar-speedy-soft-my',brand:'Tibhar',name:'Speedy Soft MY · 1.5 mm',speed:69,control:82,spin:61,hardness:42},
  {id:'tibhar-speedy-spin',brand:'Tibhar',name:'Speedy Spin · 2.0 mm',speed:62,control:81,spin:71,hardness:45},
  {id:'tibhar-super-defense-40',brand:'Tibhar',name:'Super Defense 40 · 1.0 mm',speed:45,control:89,spin:78,hardness:45},
  {id:'tibhar-super-defense-40-soft',brand:'Tibhar',name:'Super Defense 40 Soft · 1.0 mm',speed:42,control:91,spin:78,hardness:35},
  {id:'tibhar-vari-spin',brand:'Tibhar',name:'Vari Spin · 1.8 mm',speed:54,control:86,spin:75,hardness:38},
  {id:'tibhar-vari-spin-d-tecs',brand:'Tibhar',name:'Vari Spin D.Tecs · 1.8 mm',speed:56,control:80,spin:75,hardness:32.5},
  {id:'tibhar-volcano-plus',brand:'Tibhar',name:'Volcano+ · 1.8 mm',speed:53,control:84,spin:70,hardness:40},
  ...
  {id:'yinhe-955-long',brand:'Yinhe',name:'955 Long · 0.7 mm',speed:38,control:91,spin:66,hardness:25},
  {id:'yinhe-big-dipper-iv',brand:'Yinhe',name:'Big Dipper IV · 2.1 mm',speed:83,control:75,spin:94,hardness:40},
  {id:'yinhe-big-dipper-tour',brand:'Yinhe',name:'Big Dipper Tour · 2.1 mm',speed:88,control:71,spin:96,hardness:41},
  {id:'yinhe-earth-ii',brand:'Yinhe',name:'Earth II · 2.1 mm',speed:70,control:84,spin:80,hardness:40},
  {id:'yinhe-jupiter-iii',brand:'Yinhe',name:'Jupiter III · 2.1 mm',speed:85,control:73,spin:95,hardness:40},
  {id:'yinhe-mercury-ii',brand:'Yinhe',name:'Mercury II · 2.1 mm',speed:68,control:84,spin:78,hardness:40},
  {id:'yinhe-moon-12',brand:'Yinhe',name:'Moon 12 · 2.1 mm',speed:82,control:78,spin:92,hardness:42},
  {id:'yinhe-moon-speed',brand:'Yinhe',name:'Moon Speed · 2.1 mm',speed:75,control:74,spin:88,hardness:47},
  {id:'yinhe-pluto',brand:'Yinhe',name:'Pluto · 1.8 mm',speed:72,control:81,spin:70,hardness:40},
  {id:'yinhe-qing',brand:'Yinhe',name:'Qing · 0.5 mm',speed:36,control:90,spin:68,hardness:25},
  {id:'yinhe-uranus-poly',brand:'Yinhe',name:'Uranus Poly · MAX',speed:77,control:78,spin:76,hardness:42},
  {id:'yinhe-uranus-pro',brand:'Yinhe',name:'Uranus Pro · 1.8 mm',speed:75,control:80,spin:74,hardness:40},
...
function isCzech(){return document.documentElement.lang==='cs';}
function customThicknessPlaceholder(){return isEnglish()?'Other thickness (mm)':isCzech()?'Jiná tloušťka (mm)':'Iná hrúbka (mm)';}
...
function renderThickness(setup,part,modelId){
  ...
  let field=$(id);
  if(field.tagName!=='SELECT'){const select=document.createElement('select');select.id=id;select.setAttribute('aria-label',isEnglish()?'Rubber thickness':isCzech()?'Tloušťka potahu':'Hrúbka poťahu');field.replaceWith(select);field=select;}
...
const feedbackStorageKey='racket-comparator-feedback',feedbackRetentionMs=30*24*60*60*1000;
function savedFeedback(){try{const cutoff=Date.now()-feedbackRetentionMs,items=JSON.parse(localStorage.getItem(feedbackStorageKey)||'[]').filter(item=>item&&typeof item.message==='string'&&typeof item.createdAt==='string'&&Date.parse(item.createdAt)>=cutoff).map(({topic,message,createdAt})=>({topic,message,createdAt}));localStorage.setItem(feedbackStorageKey,JSON.stringify(items));return items;}catch{return [];}}
function submitFeedback(event){event.preventDefault();const message=$('feedback-message').value.trim();if(!message)return;const suggestions=savedFeedback();suggestions.push({topic:$('feedback-type').value,message,createdAt:new Date().toISOString()});localStorage.setItem(feedbackStorageKey,JSON.stringify(suggestions));$('feedback-status').textContent=isEnglish()?'Thank you — your suggestion is stored in this browser for 30 days.':isCzech()?'Děkujeme — návrh je uložen v tomto prohlížeči na 30 dní.':'Ďakujeme — návrh je uložený v tomto prehliadači na 30 dní.';event.currentTarget.reset();}
function clearFeedback(){localStorage.removeItem(feedbackStorageKey);$('feedback-status').textContent=isEnglish()?'Saved suggestions have been deleted.':isCzech()?'Uložené návrhy byly vymazány.':'Uložené návrhy boli vymazané.';}
...
function setAnalyticsConsent(granted){
  localStorage.setItem('racket-comparator-analytics-consent',granted?'granted':'denied');
...
function initializeAnalyticsConsent(){
  const saved=localStorage.getItem('racket-comparator-analytics-consent');
  if(saved){$('analytics-consent').hidden=true;if(saved==='granted'&&typeof window.gtag==='function')window.gtag('consent','update',{analytics_storage:'granted'});return;}
  $('analytics-accept').addEventListener('click',()=>setAnalyticsConsent(true));
  $('analytics-decline').addEventListener('click',()=>setAnalyticsConsent(false));
}
...
function comparisonYearNotices(current,target,english=false){
  ...
  if(isCzech())return current2026?[
    'Porovnáváme aktuální dřeva a potahy z roku 2026.',
    'Hodnocení hry také porovnává aktuální dřeva a potahy z roku 2026.',
    'Závěrečný verdikt porovnává aktuální dřeva a potahy z roku 2026.'
  ]:[
    `Vybrané verze dřev jsou z let ${current.year} a ${target.year}; potahy používají aktuální katalog 2026.`,
    `Analýza respektuje roky dřev ${current.year} a ${target.year} a aktuální údaje potahů 2026.`,
    `Závěrečný verdikt používá vybrané roky dřev a aktuální potahy 2026.`
  ];
...
function fourWayAudit(current,target,delta,english=false){
  ...
  if(isCzech()){
    const checks=[
      ['1 / Technické údaje',constructionOk?`Konstrukce, pocit, rychlost, kontrola a spin modelů ${a} a ${b} jsou vnitřně konzistentní.`:'V katalogu chybí část konstrukčních údajů, proto je verdikt záměrně opatrnější.'],
      ['2 / Souhra celé sestavy',hardRubbers>=3?'Kontrola zachytila převážně tvrdou kombinaci potahů; větší váhu proto má načasování, fyzické nasazení a tuhost dřeva.':'Vzájemné působení dřeva, FH a BH nevykazuje neobvykle vysoké riziko tvrdosti.'],
      ['3 / Kontrola herních situací','Směr verdiktu byl samostatně prověřen při krátké hře, prvním topspinu, bloku/protiútoku a hře ve střední vzdálenosti.'],
      ['4 / Kontrola rozporů a odolnosti',closeResult?'Číselné rozdíly jsou malé. Výsledek se proto uvádí jako tendence, ne jako jednoznačný vítěz.':'Hlavní rozdíly zůstaly ve stejném směru i po oddělené kontrole rychlosti, kontroly a spinu.']
    ];
    return `<section class="validation-audit"><div class="validation-heading"><div><span>4× VNITŘNÍ KONTROLA DOKONČENA</span><h3>Ověření výsledku před verdiktem</h3></div><b>4/4</b></div><div class="validation-grid">${checks.map(check=>`<article><h4>${check[0]}</h4><p>${check[1]}</p></article>`).join('')}</div><div class="review-check"><strong>Blogy a recenze hráčů:</strong> zkušenosti komunity slouží jako kontrola rozumnosti tam, kde máme ověřené recenze konkrétního modelu. Nikdy nepřepisují oficiální konstrukční údaje a stránka netvrdí, že při kliknutí provádí živé vyhledávání webu.</div></section>`;
  }
  const checks=[
...
function briefResult(current,target,delta){
  ...
  if(isCzech())return briefResultCzech(current,target,delta);
...
function briefResultCzech(current,target,delta){
  const currentBlade=bladeName('current'),targetBlade=bladeName('target'),sameRubbers=current.fh.name===target.fh.name&&current.bh.name===target.bh.name;
  const faster=delta.speed>=0?targetBlade:currentBlade,controlled=delta.control>=0?targetBlade:currentBlade,spinny=delta.spin>=0?targetBlade:currentBlade;
  const hardCurrent=['tvrdý','pevný'].includes(current.blade.feel),hardTarget=['tvrdý','pevný'].includes(target.blade.feel),closeTable=hardCurrent!==hardTarget?(hardCurrent?currentBlade:targetBlade):faster;
  const feelScore=blade=>blade.feel==='mäkký'?'9,0/10':blade.feel==='pružný'?'8,5/10':'7,0/10';
  const rows=[['Rychlost',score10(current.speed),score10(target.speed)],['Kontrola v pomalé hře',score10(current.control),score10(target.control)],['Cit v ruce',feelScore(current.blade),feelScore(target.blade)],['Stabilita při tvrdém úderu',score10(current.speed+8),score10(target.speed+8)],['Krátká hra',score10(current.control+3),score10(target.control+3)],['Blok a protiútok',score10(current.speed+4),score10(target.speed+4)],['První topspin',score10(current.spin),score10(target.spin)],['Hra ve střední vzdálenosti',score10(current.speed+2),score10(target.speed+2)]];
  const notices=comparisonYearNotices(current,target),rubberLine=sameRubbers?`Obě sestavy používají <b>${current.fh.name}</b> na FH a <b>${current.bh.name}</b> na BH.`:`Potahy se mezi sestavami liší, proto porovnání zohledňuje také jejich rychlost, spin a zvolenou tloušťku.`;
  return `<div class="brief-result"><p class="brief-rubber"><b>${notices[0]}</b> ${rubberLine}</p>${fourWayAudit(current,target,delta)}<h2 class="short-result-title">KRÁTKÝ VÝSLEDEK</h2><table class="brief-table"><thead><tr><th>Vlastnost</th><th>${currentBlade} (${current.year})</th><th>${targetBlade} (${target.year})</th></tr></thead><tbody>${rows.map(row=>`<tr><td>${row[0]}</td><td>${row[1]}</td><td>${row[2]}</td></tr>`).join('')}</tbody></table><div class="brief-grid"><section><h3>Hra u stolu</h3><p>V krátké hře a při příjmu nabídne více jistoty <b>${controlled}</b>. Pro aktivní blok, BH punch a rychlý flick má větší potenciál <b>${closeTable}</b>.</p></section><section><h3>Topspiny</h3><p>Více spinu a oblouku přinese <b>${spinny}</b>. <b>${faster}</b> bude při správném načasování nebezpečnější při druhém topspinu a zakončení.</p></section><section><h3>Blok a protiútok</h3><p>Při silném míči jsou výhodou pevnější kontakt a rychlost — zde má přednost <b>${faster}</b>. <b>${controlled}</b> dá více času na tlumení a změnu tempa.</p></section><section><h3>Střední vzdálenost</h3><p><b>${faster}</b> poskytne větší rezervu hloubky a průraznosti. <b>${controlled}</b> lépe pomáhá vyšším obloukem a bezpečnějšími spinovými výměnami.</p></section></div><div class="brief-takeaway"><h3>Co ucítíš nejvíce</h3><ul><li>${faster}: rychlejší odchod míče a více rezervy při útoku.</li><li>${controlled}: více zpětné vazby a klidnější krátká hra.</li><li>${notices[1]}</li><li>Přesný výsledek ještě ovlivní hmotnost konkrétního kusu a tvoje načasování.</li></ul></div><p class="brief-method"><b>${notices[2]}</b> Porovnání vychází z konstrukce dřeva, parametrů potahů a zvolené tloušťky. Je to praktická predikce, ne náhrada fyzického testu.</p></div>${longAnalysisCzech(current,target,delta)}`;
}
...
function longAnalysisCzech(current,target,delta){
  const a=bladeName('current'),b=bladeName('target'),faster=delta.speed>=0?b:a,controlled=delta.control>=0?b:a;
  const same=current.fh.name===target.fh.name&&current.bh.name===target.bh.name;
  return `<section class="long-analysis"><h2>PODROBNÁ ANALÝZA:</h2><p class="long-lead">Porovnáváme <b>${a}</b> a <b>${b}</b>. ${same?'Potahy jsou stejné, proto bude rozdíl ve hře vycházet hlavně ze dřeva.':'Dřevo i potahy se liší, proto výsledný pocit vytváří celá sestava.'}</p><div class="long-analysis-grid"><article><h3>1. Konstrukce a základní charakter</h3><p><b>${a}</b> je v databázi vedené jako ${current.blade.type} s ${current.blade.feel} pocitem. <b>${b}</b> používá ${target.blade.type} a má ${target.blade.feel} charakter. Materiál, poloha kompozitu a tvrdost kontaktu rozhodují o tom, jak brzy dřevo začne vracet energii.</p></article><article><h3>2. První míče po výměně</h3><p>Nejrychleji si všimneš rozdílu v tom, jak brzy míč opouští pálku. <b>${faster}</b> bude při aktivním kontaktu působit přímočařeji a s větší rezervou. <b>${controlled}</b> dá více času cítit kontakt a upravit úhel pálky.</p></article><article><h3>3. Krátká hra a příjem podání</h3><p>Při krátkém příjmu, stop-balu a jemném dotyku má přednost <b>${controlled}</b>. Při agresivním flicku, banánu nebo přímém útoku z podání poskytne více tlaku <b>${faster}</b>. U citlivých potahů rozhoduje přesnost úhlu a aktivní ruka.</p></article><article><h3>4. První FH topspin proti spodní rotaci</h3><p><b>${controlled}</b> bude obvykle jednodušší na bezpečný obloukový první topspin a tenký kontakt. <b>${faster}</b> potřebuje lepší zrychlení a kontakt před tělem, ale při správné technice vytvoří rychlejší a průraznější míč.</p></article><article><h3>5. Druhý topspin a tlak do bloku</h3><p>Když je míč výš nebo se vrátí soupeřův blok, <b>${faster}</b> má větší potenciál hrát více dopředu, tvrdě a hluboko. <b>${controlled}</b> je výhodný, když chceš držet bezpečnou spinovou výměnu a měnit tempo.</p></article><article><h3>6. BH topspin, blok a protiútok</h3><p>Na BH bude pevnější a rychlejší dřevo odměňovat krátký aktivní pohyb, punch a blok. Citlivější dřevo poskytne více času na otevření proti spodní rotaci. Při silném soupeřově topspinu má <b>${faster}</b> větší stabilitu, <b>${controlled}</b> více možností tlumení.</p></article><article><h3>7. Střední vzdálenost a hra dál od stolu</h3><p>Ve střední vzdálenosti má <b>${faster}</b> větší rezervu hloubky a méně vyžaduje maximální švih. <b>${controlled}</b> více pomáhá vyšším obloukem a vytažením nízkého míče, ale energii musíš častěji vytvářet vlastním tělem a předloktím.</p></article><article><h3>8. Podání a odpuštění chyb</h3><p>Při podání je důležitější dotyk a potah než samotná maximální rychlost dřeva. <b>${controlled}</b> má výhodu při jemném krátkém podání, <b>${faster}</b> při rychlém dlouhém podání. Pomalé technické chyby odpouští více citlivější dřevo, silné údery stabilnější dřevo.</p></article><article><h3>9. Vliv konkrétního kusu</h3><p>Hmotnost, vyvážení, tvar rukojeti a skutečná tloušťka potahů mohou rozdíl citelně změnit. U dvou tvrdších potahů může i rozdíl několika gramů rozhodnout o rychlosti BH přepínání a únavě předloktí.</p></article><article><h3>10. Verdikt pro výběr</h3><p>Zvol <b>${controlled}</b>, pokud je prioritou cit, krátká hra, bezpečný první topspin a technický trénink. Zvol <b>${faster}</b>, pokud chceš aktivní blok, protiútok, tlak ve střední vzdálenosti a tvrdší zakončení. Nejlepší rozhodnutí stále potvrdí test s vlastními potahy.</p></article></div></section>`;
}
...
function compare(shouldScroll=true,shouldTrack=false){
  ...
  const english=isEnglish(),czechLanguage=isCzech();
  const label=english?(score>=80?'A very promising change':score>=65?'A change with reasonable potential':'This change will require adaptation'):czechLanguage?(score>=80?'Velmi slibná změna':score>=65?'Změna s rozumným potenciálem':'Změna bude vyžadovat adaptaci'):(score>=80?'Veľmi sľubná zmena':score>=65?'Zmena s rozumným potenciálom':'Zmena si vyžiada adaptáciu');
  $('result-title').textContent=`${bladeName('current')} (${current.year}) vs. ${bladeName('target')} (${target.year})`;$('result-summary').textContent=english?`A quick comparison of blade versions from ${current.year} and ${target.year}, with rubbers and selected thickness.`:czechLanguage?`Rychlé porovnání verzí dřev z let ${current.year} a ${target.year}, potahů a zvolené tloušťky.`:`Rýchle porovnanie verzií driev z rokov ${current.year} a ${target.year}, poťahov a zvolenej hrúbky.`;$('score-value').textContent=score;$('score-ring').style.setProperty('--score',score);$('compatibility-label').textContent=label;$('compatibility-detail').textContent=english?(score>=80?'The change matches your technique and training frequency.':score>=65?'The setup makes sense, but it will require deliberate adaptation.':'The potential is high, but the setup may be less forgiving.'):czechLanguage?(score>=80?'Změna odpovídá tvé technice a frekvenci tréninků.':score>=65?'Sestava dává smysl, ale bude vyžadovat vědomou adaptaci.':'Potenciál je vysoký, ale sestava může méně odpouštět.'):(score>=80?'Zmena zodpovedá tvojej technike a frekvencii tréningov.':score>=65?'Zostava dáva zmysel, no bude vyžadovať vedomú adaptáciu.':'Potenciál je vysoký, ale zostava môže byť menej odpúšťajúca.');
  document.querySelector('.comparison-details').innerHTML=briefResult(current,target,delta);
  if(shouldTrack)trackComparison();
  const results=$('results');results.classList.remove('hidden');if(shouldScroll)results.scrollIntoView({behavior:'smooth',block:'start'});
}
window.dataLayer=window.dataLayer||[];window.gtag=window.gtag||function(){window.dataLayer.push(arguments);};window.gtag('consent','default',{analytics_storage:'denied'});window.gtag('js',new Date());window.gtag('config','G-1HD6YG4XCX',{anonymize_ip:true});$('compare-button').addEventListener('click',()=>compare(true,true));$('feedback-form').addEventListener('submit',submitFeedback);$('feedback-clear').addEventListener('click',clearFeedback);initialize();savedFeedback();initializeAnalyticsConsent();setLanguage('en');
